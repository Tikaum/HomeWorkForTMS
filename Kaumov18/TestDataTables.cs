...
namespace TestProjectKaumov
{
    internal class TestDataTables
    {
        ...
        public void Test1()
        {
            ...
            Assert.AreEqual("Smith", cellValue, "The cell contents NO match the required ones.");
            ...
            Assert.AreEqual("$100.00", cellValue, "The cell contents NO match the required ones.");
            ...
            Assert.AreEqual("Tim", cellValue, "The cell contents NO match the required ones.");
            ...
            Assert.AreEqual("Conway", cellValue, "The cell contents NO match the required ones.");
            ...
            Assert.AreEqual("http://www.jdoe.com", cellValue, "The cell contents NO match the required ones.");
            driver.Quit();
        }
    }
}
